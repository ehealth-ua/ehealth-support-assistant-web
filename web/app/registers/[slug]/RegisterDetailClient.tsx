...
export default function RegisterDetailClient({ slug }: { slug: string }) {
  ...
  // Get registry details from translations (shape varies per registry → any)
  const registryDetails: any = (t.registryDetails as Record<string, any> | undefined)?.[item.slug];
